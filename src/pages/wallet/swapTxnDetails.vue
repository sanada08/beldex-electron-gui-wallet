  ...
  <div class="swapTxnDetails">
    ...
    <header class="flex row items-center q-mb-md justify-between">
      <div class="flex items-center back-arrow-btn">
        ...
        <div class="ft-semibold q-ml-md header-txt">Confirmation</div>
      </div>
    </header>
    ...
    <section class="q-mt-lg">
      ...
      <article class="q-mt-md flex items-center">
        <!-- <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <article class="warning-wrapper q-mt-md">
        ...
        <span class="q-ml-sm warn-txt"
          >The funds were not received within 3 hours. Please check the rates
          and create a new transaction</span
        >
      </article>
    </section>
